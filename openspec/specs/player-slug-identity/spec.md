# Player Slug Identity

## Purpose

Define how a player is addressed by id-or-slug on the public and admin routes, and the single canonical `Player.Slug` format shared by create, seed, and re-backfill.
