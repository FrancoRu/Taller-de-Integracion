        ...
        {tab === 'puntuaciones' && (
          <Stack spacing={2}>
            <Typography variant="body1">
              Resumen de puntuaciones del partido.
            </Typography>
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" mt={1}>
                      {homeTeam?.name || 'Sin equipo asignado'}
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} md={6}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" mt={1}>
                      {visitorTeam?.name || 'Sin equipo asignado'}
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
            ...
            <Divider />
            <Typography variant="body2" color="text.secondary">
              El detalle individual de puntuaciones por jugador todavía no está
              expuesto por el contexto actual de player statistics.
            </Typography>
          </Stack>
        )}
