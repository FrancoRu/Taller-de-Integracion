...
public class BlogPostEntityConfiguration : BaseEntityConfiguration<BlogPost>
{
    protected override void ConfigureEntity(EntityTypeBuilder<BlogPost> builder)
    {
        ...
        // Defaults to true so every pre-existing post back-filled by the migration stays publicly visible, and any future insert that omits the flag is treated as published.
