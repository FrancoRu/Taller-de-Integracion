...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260907042600_WidenDivisionNameMaxLength")]
    partial class WidenDivisionNameMaxLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Models.Team", b =>
                {
                    ...
                    b.Property<string>("ShirtTertiaryColor")
                        .HasMaxLength(9)
                        .HasColumnType("character varying(9)");
            ...
            modelBuilder.Entity("Domain.Entities.Models.TeamPointDeduction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DateCreated")
                        .HasDatabaseName("IX_TeamPointDeduction_CreatedAt");

                    b.HasIndex("DivisionId");

                    b.HasIndex("TeamId");

                    b.ToTable("TeamPointDeductions", "Club12");
                });

            modelBuilder.Entity("Domain.Entities.Models.TeamStaff", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DateCreated")
                        .HasDatabaseName("IX_TeamStaff_CreatedAt");

                    b.HasIndex("TournamentId");

                    b.HasIndex("TeamId", "TournamentId");

                    b.ToTable("TeamStaffs", "Club12");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Models.Club", b =>
                {
                    b.HasOne("Domain.Entities.Models.Club", "ParentClub")
                        .WithMany("ChildClubs")
