...
namespace Club12.Services.Services.StaffService.Implementation;
...
public class StaffService(IGenericService<Staff> _genericStaffService) : IStaffService
{
    ...
    {
        return await _genericStaffService.FilterByExpression(staff => staff.Id == staffId).FirstOrDefaultAsync();
    }
