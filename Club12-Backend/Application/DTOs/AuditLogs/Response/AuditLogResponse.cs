...
/// <summary>
/// Audit-trail entry as returned by the listing endpoint (HU-101).
/// </summary>
public class AuditLogResponse : BaseEntityResponse
{
    /// <summary>The sensitive action that was performed (enum name).</summary>
    public required string Action { get; set; }

    /// <summary>Who performed the action (email, or "System").</summary>
    public required string Actor { get; set; }

    /// <summary>The kind of entity targeted, when applicable.</summary>
